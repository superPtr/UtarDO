...
public class AddTask extends AppCompatActivity {
    ...
    public void addTask(View view) {
        ...
        if (labelID == null || courseID == null || taskTitle.isEmpty()) {
            ...
            //taskData.put("taskStatus", );
            //taskDate.put("reminderStatus");
            //startDate.put("");
            //endDate.put("");
            ...
            docRef.set(taskData)
                    .addOnSuccessListener(aVoid -> {
                        ...
                        // Handler to delay starting the View Specific Courses Activity
                        new Handler().postDelayed(() -> {
                            // Back to View Course Page
//                            Intent intent = new Intent(AddTask.this, ViewSpecificCourse.class);
